const ITEMS = [
  ...
  { severity: 'HIGH', color: 'text-accent-blue', dot: 'bg-accent-blue', msg: 'API keys exposed: fintech-startup.com · GitHub leak', time: '11m ago' },
  ...
  { severity: 'HIGH', color: 'text-accent-blue', dot: 'bg-accent-blue', msg: 'Subdomain indexed: mail.medcare.in · dark web crawler', time: '34m ago' },
